...
export class TransactionManager {
    ...
    deleteItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.DeleteItemOutput> {
        return this.chain.deleteItem(record, item, expected);
    }

    putItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.PutItemOutput> {
    ...
    updateItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.UpdateItemOutput> {
...
class TransactionManagerNotifier implements TransactionCallbackChain {
    ...
    putItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.PutItemOutput> {
        return this.cb.putItem(this.cbc, record, item, expected);
    }

    deleteItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.DeleteItemOutput> {
        return this.cb.deleteItem(this.cbc, record, item, expected);
    }

    updateItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.PutItemOutput> {
...
class DefaultTransaction implements TransactionCallbackChain {
    ...
    async putItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.PutItemOutput> {
    ...
    async deleteItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.DeleteItemOutput> {
    ...
    async updateItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.PutItemOutput> {
        return this.session.putItem({
            TableName: this.config.tableName,
            Item: item.toMap(),
            Expected: expected.toMap(),
