...
import {ViewProjectedType, ViewQueryDef, ViewSourceDef} from "../../view/index";
...
export type ViewType<V extends object = any> = {
     ...
     */
    readonly columns: ViewColumnProperty<V, any>[],

    /** All the properties that will be exposed when calling JSON.stringify(). */
    readonly exposed: ObjectProperty<V, any>[],
     ...
     */
    readonly pk: IdColumnProperty<V>,
     ...
     */
    readonly sk?: IdColumnProperty<V>,
