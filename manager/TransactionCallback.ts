...
export interface TransactionCallback {
    ...
    updateItem<E extends object>(chain: TransactionCallbackChain, record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.UpdateItemOutput>
...
export interface TransactionCallbackChain {
    ...
    updateItem<E extends object>(record: EntityTypeProxy<E>, item: AttributeMapper, expected: ExpectedMapper): Promise<DynamoDB.Types.UpdateItemOutput>;

}

export type GetItemInput<E extends object = any> = {
    readonly record: EntityTypeProxy<E>,
