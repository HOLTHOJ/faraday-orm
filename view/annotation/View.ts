...
export type ViewProjectedType = "ALL" | "KEYS_ONLY" | Array<string>;
...
export type ViewOptions = {
    ...
    /**
     * If TRUE then the entity Key attributes will by default be exposed. Defaults to TRUE.
     */
    exportKeys?: boolean,
 ...
 */
export function View(viewName: string, indexName: string, options?: ViewOptions) {
    return (ctor: { new(...args: any[]): {} }) => {
        ...
        const viewDef: ViewDef = {
            ...
            indexName: indexName,
            options: {
                exportKeys: def(options?.exportKeys, false),
